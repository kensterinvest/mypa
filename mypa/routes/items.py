...
def get_item_by_id(item_id: int, db: Session = Depends(get_session)) -> ItemOut:
...
def patch_item(
    item_id: int, patch: ItemPatch, db: Session = Depends(get_session)
) -> ItemOut:
    try:
...
def complete(item_id: int, db: Session = Depends(get_session)) -> ItemOut:
...
def delete_item_by_id(item_id: int, db: Session = Depends(get_session)) -> None:
